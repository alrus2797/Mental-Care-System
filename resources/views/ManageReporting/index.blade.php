...
<center>
    ...
    <div class="col-md-7 col-md-offset-2">
      <a href="/reportes/descargarRep" class="list-group-item ">
        <h4 class="list-group-item-heading">Descargas</h4>
        <p class="list-group-item-text">Busca y descarga los Reportes que se han generado</p>
      </a>
      <hr>
